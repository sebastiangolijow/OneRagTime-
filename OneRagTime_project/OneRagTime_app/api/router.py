...
from OneRagTime_app.api.views import  InvestmentEndpoint, InvestorEndpoint, BillEndpoint, CashcallEndpoint, GenerateBillsEndpoint, SendEmailEndpoint
...
router_endpoint_generate_bill = DefaultRouter()
router_endpoint_generate_bills = DefaultRouter()
router_endpoint_send_email = DefaultRouter()
...
router_endpoint_generate_bills.register(prefix='generate_bills', basename='generate_bills', viewset= GenerateBillsEndpoint)
router_endpoint_send_email.register(prefix='send_email', basename='send_email', viewset= SendEmailEndpoint)
